...
forward(40) # 60s = 0.02kp  50s = 0.012kP
...
# Turn PWM off after 30 ms
    ...
    black_mask[ROBOT_Y1:HEIGHT, ROBOT_X1:ROBOT_X2] = 0
    ...
    blue_mask[ROBOT_Y1:HEIGHT, ROBOT_X1:ROBOT_X2] = 0
    ...
    orange_mask[ROBOT_Y1:HEIGHT, ROBOT_X1:ROBOT_X2] = 0
